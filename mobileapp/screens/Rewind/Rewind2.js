...
export default function Rewind2() {
  return (
...
//     gl.clearColor(240.0 / 255.0, 240.0 / 255.0, 240.0 / 255.0, 0.0); // #f0f0f0
...
//   return (
//     <>
//       {/*** LAYER 1: Animated gradient behind everything ***/}
//       <AnimatedShader style={StyleSheet.absoluteFill} />

//       {/*** LAYER 2: Your existing GL triangles ***/}
//       <GLView style={styles.background} onContextCreate={onContextCreate} />

//       {/*** LAYER 3: Your RewindScreen2 content on top ***/}
